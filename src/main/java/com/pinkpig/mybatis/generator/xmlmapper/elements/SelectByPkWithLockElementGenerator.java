...
/**
 * 按主键生成for update sqlMap
 * @author vincenfeng
 * 
 */
public class SelectByPkWithLockElementGenerator extends
        AbstractXmlElementGenerator {

    public SelectByPkWithLockElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", PluginInternalAttribute.ATTR_METHOD_SELECT_BY_PK_WHITH_LOCK.getValue())); //$NON-NLS-1$
