...
public class SelectByIndexWithoutBLOBsElementGenerator extends
        AbstractXmlElementGenerator {

    private IntrospectedIndex introspectedIndex;
    
    public SelectByIndexWithoutBLOBsElementGenerator(IntrospectedIndex introspectedIndex) {
        super();
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", String.format(PluginInternalAttribute.ATTR_METHOD_SELECT_BY_INDEX.getValue(),
