                    ...
                    if (ele instanceof XmlElement) {
                        ...
                        if (eleId != null) {
                            if (eleId.startsWith(id)) {
                                ...
                                if((id.startsWith("select") && eleId.startsWith("select"))
                                        ||(id.startsWith("update") && eleId.startsWith("update"))
                                        ||(id.startsWith("delete") && eleId.startsWith("delete"))){
                                    if(index==-1 || index==i){
                                        index = i + 1;
                                    }
                                }
    ...
    private static void addMethodWithBestPosition(Method method, List<Method> methods) {
        ...
        for (int i = 0; i < methods.size(); i++) {
            ...
            if (m.getName().equals(method.getName())) {
                ...
                if((m.getName().startsWith("select") && method.getName().startsWith("select"))
                        ||(m.getName().startsWith("update") && method.getName().startsWith("update"))
                        ||(m.getName().startsWith("delete") && method.getName().startsWith("delete"))){
                    if(index==-1 || index==i){
                        index = i + 1;
                    }
                }
