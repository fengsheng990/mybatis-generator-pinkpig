 ...
 * @version V1.0
 */
public class SelectByUkIndexMethodGenerator extends
        AbstractJavaMapperMethodGenerator {

    private IntrospectedIndex introspectedIndex;
    
    public SelectByUkIndexMethodGenerator(IntrospectedIndex introspectedIndex) {
        super();
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        method.setName(PluginInternalAttribute.ATTR_METHOD_SELECT_BY_UK_INDEX.getValue());
